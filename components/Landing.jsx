    ...
    <>
      ...
      <div className="bg-[#051139] w-full h-full flex flex-col items-center justify-center p-10 gap-6 relative">
        ...
        <div className="relative mt-8 ">
          <div className="absolute -z-5 left-0 top-0 rounded-[100%] w-[380px] h-[240px] bg-[#9C08FF] blur-[100px] "></div>
          <div className="absolute -z-5 -right-0 -top-10 rounded-[100%] w-[400px] h-[440px] bg-[#1E50FF] blur-[120px] "></div>
